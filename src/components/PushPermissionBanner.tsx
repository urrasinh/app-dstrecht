...
export const PushPermissionBanner: React.FC = () => {
    ...
    if (perm === 'denied') {
        return (
            <div className="shrink-0 bg-amber-950/40 border-b border-amber-900/50 px-4 py-2.5 flex items-center gap-3">
                ...
                <div className="flex-1 min-w-0">
                    <div className="text-xs font-bold text-amber-300">Notificaciones bloqueadas</div>
                ...
                <button onClick={onDismiss} className="text-amber-400 hover:text-amber-200 text-lg leading-none px-1 shrink-0">×</button>
            </div>
        );
    }

    return (
        <div className="shrink-0 bg-emerald-950/40 border-b border-emerald-900/50 px-4 py-2.5 flex items-center gap-3">
            ...
            <div className="flex-1 min-w-0">
                <div className="text-xs font-bold text-emerald-300">Activa las notificaciones</div>
                <div className="text-[10px] text-emerald-200/80 leading-tight mt-0.5">
            ...
            <button
                onClick={onActivate}
                disabled={busy}
                className="bg-emerald-600 hover:bg-emerald-500 text-white text-[11px] font-bold uppercase tracking-wider px-3 py-1.5 rounded-lg disabled:opacity-50 shrink-0"
            >
                {busy ? '...' : 'Activar'}
            </button>
            <button onClick={onDismiss} className="text-emerald-400 hover:text-emerald-200 text-lg leading-none px-1 shrink-0">×</button>
        </div>
    );
};
