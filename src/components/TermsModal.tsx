...
export const TermsModal: React.FC<{ isOpen: boolean; onClose: () => void }> = ({ isOpen, onClose }) => {
    ...
    return (
        <div className="fixed inset-0 z-[400] bg-black/70 backdrop-blur-sm flex items-center justify-center p-4" onClick={onClose}>
            <div
                className="bg-slate-900 border border-slate-700 rounded-2xl max-w-md w-full max-h-[85dvh] flex flex-col shadow-2xl"
            ...
            >
                ...
                <div className="overflow-y-auto px-5 py-4 text-sm text-slate-300 leading-relaxed space-y-4">
                    <p>
                    ...
                    <section className="space-y-1.5">
                        <h3 className="text-emerald-400 text-xs font-bold uppercase tracking-wider">Uso de datos</h3>
                        <p>
                    ...
                    <section className="space-y-1.5">
                        <h3 className="text-emerald-400 text-xs font-bold uppercase tracking-wider">Integridad y seguridad</h3>
                        <p>
                    ...
                    <section className="space-y-1.5">
                        <h3 className="text-emerald-400 text-xs font-bold uppercase tracking-wider">Finalidad</h3>
                        <p>
                    ...
                    <section className="space-y-1.5">
                        <h3 className="text-emerald-400 text-xs font-bold uppercase tracking-wider">Responsabilidad del usuario</h3>
                        <p>
